...
def yolo_non_max_suppression(scores, boxes, classes, max_boxes = 10, iou_threshold = 0.5):
    ...
    #  tf.image.non_max_suppression() to get the list of indices corresponding to boxes you keep
  
    nms_indices = tf.image.non_max_suppression(boxes=boxes , scores=scores , iou_threshold=iou_threshold ,max_output_size=max_boxes_tensor,)
...
def yolo_eval(yolo_outputs, image_shape = (720., 1280.), max_boxes=10, score_threshold=.6, iou_threshold=.5):
    ...
    scores, boxes, classes = yolo_filter_boxes(boxes=boxes , box_class_probs= box_class_probs ,box_confidence= box_confidence , threshold=score_threshold)
