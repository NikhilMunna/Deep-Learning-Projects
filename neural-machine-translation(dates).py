...
def one_step_attention(a, s_prev):
    ...
    #  densor1 to propagate concat through a small fully-connected neural network to compute the "intermediate energies" variable e. (≈1 lines)
    e = densor1(concat)
    #  densor2 to propagate e through a small fully-connected neural network to compute the "energies" variable energies. (≈1 lines)
    energies = densor2(e)
...
def model(Tx, Ty, n_a, n_s, human_vocab_size, machine_vocab_size):
    ...
    #  the inputs of your model with a shape (Tx,)
    ...
    # Step 1:  your pre-attention Bi-LSTM. Remember to use return_sequences=True.
